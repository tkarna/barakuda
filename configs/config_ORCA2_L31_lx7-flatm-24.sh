...
export HOST=lx7-flatm-24 ; # this has no importance at all, it will just become an "info" on the web-page!
export EXTRA_CONF="LIM3, NEMO 3.6" ;   #  // same here ...

export STORE_DIR=${HOME}"/tiede/NEMO"

export CONF_INI_DIR=${HOME}"/tiede/NEMO/"${HCONF}

export DIAG_DIR=${HOME}"/tiede/NEMO/barakuda_diags/${CONF}"

export PYTHON_HOME="/usr/bin/python" ; # HOME to python distribution with matplotlib and basemap !
...
export NEMO_OUT_STRCT="${STORE_DIR}/NEMOGCM/CONFIG/ORCA2_LIM3_XIOS/"${EXP}
